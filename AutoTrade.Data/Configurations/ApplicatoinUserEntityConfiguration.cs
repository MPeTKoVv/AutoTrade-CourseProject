	...
	public class ApplicatoinUserEntityConfiguration : IEntityTypeConfiguration<ApplicationUser>
	{
		...
		public ApplicationUser[] SeedUsers()
		{
			...
			user = new ApplicationUser()
			{
				...
				FirstName = "Gosho",
				LastName = "Georgiev",
				SecurityStamp = UserEmail,
				WalletId = Guid.Parse(UserWalletId)
            };
			...
			user = new ApplicationUser()
			{
				...
				FirstName = "Pesho",
				LastName = "Petrov",
				SecurityStamp = SellerEmail,
				WalletId = Guid.Parse(SellerWalletId)
            };
			user.PasswordHash = hasher.HashPassword(user, "123456");
			...
			user = new ApplicationUser()
			{
				...
				FirstName = "Great",
				LastName = "Admin",
				SecurityStamp = AdminEmail,
				WalletId = Guid.Parse(AdminWalletId)
            };
			user.PasswordHash = hasher.HashPassword(user, "123456");
