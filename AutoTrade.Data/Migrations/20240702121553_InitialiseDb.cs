    ...
    public partial class InitialiseDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    NameOnCard = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    CardNumber = table.Column<string>(type: "nvarchar(16)", maxLength: 16, nullable: false),
                    ExpirationDate = table.Column<string>(type: "nvarchar(5)", maxLength: 5, nullable: false),
                    CVVCode = table.Column<string>(type: "nvarchar(4)", maxLength: 4, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddedOnForSale = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()"),
                    IsActive = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("1609d5ac-cf56-4fa3-8c17-3fc19b36f4ad"), 0, "21b8fa04-fe73-4144-bd73-cb3552eb9463", "gosho@user.com", false, "Gosho", "Georgiev", false, null, "gosho@user.com", "gosho@user.com", "AQAAAAEAACcQAAAAEPAyubF0Ek2F9GPwmsy4F2KVOOKYmSmsWB3U02i0zZc5sftydNrBeG8g5hylNK3P0Q==", null, false, null, false, "gosho@user.com", null },
                    { new Guid("1f995e54-2e2d-4d3c-b612-2ea74a593474"), 0, "36812a96-1d32-4e8c-8dfb-7cd6b6f3299a", "admin2@autotrade.com", false, "Great", "Admin", false, null, "admin2@autotrade.com", "admin2@autotrade.com", "AQAAAAEAACcQAAAAECaiEJW6owYgLFr4UvN0ktZ4mFk5/uu9V05cgNw7esGDWx7lGzGiFnZ0KtTna5J3Pg==", null, false, null, false, "admin2@autotrade.com", null },
                    { new Guid("633475e7-ab79-49b2-a198-43e1777e929f"), 0, "8bfe02cc-345c-4ffd-a399-ef8ac5beb05b", "pesho@user.com", false, "Pesho", "Petrov", false, null, "pesho@user.com", "pesho@user.com", "AQAAAAEAACcQAAAAECSRPqJqPDCkhKYVNzXFPDLZzRxP5gi3uRKmZEiV1aVT67/qkXqsBs1Qf4PlabJdzQ==", null, false, null, false, "pesho@user.com", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("65fe3d63-c50b-4499-89e4-99b5f98640f0"), "+359888888888", new Guid("1f995e54-2e2d-4d3c-b612-2ea74a593474") });

            migrationBuilder.InsertData(
                table: "Sellers",
                columns: new[] { "Id", "PhoneNumber", "UserId" },
                values: new object[] { new Guid("ae885d42-849e-49c8-81b5-4fbeac003182"), "+359888888888", new Guid("633475e7-ab79-49b2-a198-43e1777e929f") });
